...
let btnLogin = window.document.querySelector(".login_entrar");
btnLogin.addEventListener('submit', ()=>{
    let inputuser = window.document.querySelector("#usuaria_login");
    let inputsenha = window.document.querySelector("#senha_login");
